            ...
            <div class="col-md-8">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" enctype='multipart/form-data' action="<?php echo base_url() ?>blog/do_edit_blog" method="post" id="blog" role="form">
                        <input type="hidden" value="<?php echo $blog_edit->id; ?>" name="blog_id" id="blog_id" />
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        <label for="title">Title</label><span class="text-red">*</span>
                                        <input type="text" class="form-control required" value="<?php echo $blog_edit->title; ?>" id="title" name="title">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="button" class="form-control image-preview-filename" value="<?php echo set_value('image', $blog_edit->image); ?>" disabled="disabled">
                                        ...
                                        <?php if(!empty($blog_edit->image)) { ?>
                                            <img src="<?php echo base_url('uploads/'.$blog_edit->image); ?>" width="150" height="100">
                                        <?php } else { ?>
                        ...
                        <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" value="<?php echo $blog_edit->description; ?>" id="description" name="description">
                                    </div>
                                </div>
                            </div>
